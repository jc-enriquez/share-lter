                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../assets/images/admin.jpg"
                                            alt="...">
...
?>
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $users_counts ?></div>
                                        </div>
                                        <div class="col-auto">
...
$element_count = [$post_counts, $comment_counts, $users_counts, $category_counts];
...
?>
                            ...
                            var options = {
                            chart: {
                                title: 'Share-lter Overview',
                                subtitle: 'Powered by BroCode',
                            }
                            };
                    ...
                    <div id="columnchart_material" style="width: 100rem; height: 500px;"></div>
