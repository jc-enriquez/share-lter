...
while ($row = mysqli_fetch_assoc($select_all_posts_query)) {
    ...
    <div class="col-lg-4 mb-3">
      <div class="card">
          <a href="post.php?p_id=<?php echo $post_id ?>"><img src="images/<?php echo $post_image ?>" class="card-img-top" alt=""></a>
          <div class="card-body">
            ...
            <a href="post.php?p_id=<?php echo $post_id ?>" class="btn btn-custom text-white">Read More <i class="fa-solid fa-eye ml-1"></i></a>
          </div>
      </div>
    </div>
<?php }?>
...
for ($i = 1; $i <= $count; $i++) {
    if ($i == $page) {
        echo "<li class='page-item'><a class='page-link text-dark active_link' href='listings.php?page={$i}'>{$i}</a></li>";
    } else {
        echo "<li class='page-item'><a class='page-link text-dark' href='listings.php?page={$i}'>{$i}</a></li>";
    }
